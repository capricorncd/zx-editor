...
import { CursorClass, changeNodeName, initContentDom, checkIsEmpty } from './core'
...
export class Editor extends EventEmitter {
  ...
  // 参数
  private readonly options: Types.EditorOptions
  // 编辑器内容区域HTML元素
  ...
  constructor(options: Types.EditorOptions) {
    super()
    // version
   ...
   */
  use(plugin: Types.EditorPlugin, parentElement?: HTMLElement): void {
