/**
 * zx-debug v1.0.2
 * https://github.com/zx1984/zx-debug
 * Copyright © 2018-present, zx1984
 * Released under the MIT License
 * Released on: 2018-08-01 22:37:47
 */
!(function (e, t) {
  ...
  return (function (e) {
    ...
    function (e, t, r) {
      'use strict'
      Object.defineProperty(t, '__esModule', { value: !0 }), (t.ZxDebug = void 0)
      var n = (function () {
          function e(e, t) {
      ...
      r(3)
      var s = { position: 'top', offset: 0, height: 0.4, title: 'Debug View', opacity: 0.8, showSwitch: !0 },
        d = (function () {
          function e() {
            ...
            n(e, [
              {
                ...
                value: function (e) {
                  var t = window.innerHeight,
                    r = e.height,
                    n = Math.max(100, r > 1 ? o.default.int(r) : t * r),
                    a = n - 30,
                    s = ('top' === e.position ? 'top' : 'bottom') + ':' + o.default.int(e.offset) + 'px',
                    d = {
                      attrs: {
                        class: 'zxeditor-debug-wrapper',
                        style:
                          'display: none;' + s + ';height:' + n + 'px;background-color:rgba(0,0,0,' + e.opacity + ')',
                      },
                      child: [
                        {
                          attrs: { class: 'zxeditor-debug-head' },
                          child: [
                            {
                              tag: 'span',
                              child: [e.title + ' ', { tag: 'i', attrs: { class: '__clear' }, child: 'clear' }],
                            },
                            { tag: 'i', attrs: { class: '__close' }, child: '[close]' },
                          ],
                        },
                        {
                          attrs: { class: 'zxeditor-debug-body', style: 'height: ' + a + 'px' },
                          child: [{ attrs: { class: 'zxeditor-debug-list' } }],
                        },
                      ],
                    }
                  ;(this.$wrapper = i.default.createVdom(d)),
                    (this.$switch = i.default.createVdom({
                      attrs: { class: 'zxeditor-debug-switch', style: s + ';' + (e.showSwitch ? '' : 'display:none') },
                    }))
                  var u = i.default.query('body')
                  null === u && o.default.err("[zxDebug]:: Cann't found body Element!"),
                    u.appendChild(this.$wrapper),
                    u.appendChild(this.$switch),
                    (this.$body = i.default.query('.zxeditor-debug-body', this.$wrapper)),
                    (this.$list = i.default.query('.zxeditor-debug-list', this.$wrapper))
                },
              },
              {
                key: '_initEvent',
                value: function (e) {
                  var t = this,
                    r = this.$switch,
                    n = i.default.query('.__close', this.$wrapper),
                    o = i.default.query('.__clear', this.$wrapper)
                  function a() {
                    t.show()
                  }
                  function s() {
                  ...
                  e
                    ? (i.default.removeEvent(r, 'click', a),
                      i.default.removeEvent(n, 'click', s),
                      i.default.removeEvent(o, 'click', d))
                    : (i.default.addEvent(r, 'click', a),
                      i.default.addEvent(n, 'click', s),
                      i.default.addEvent(o, 'click', d))
                },
              },
              {
                key: 'log',
                value: function () {
                  var e = o.default.slice(arguments)
                  this._add.apply(this, ['log'].concat(e))
                },
              },
              {
                key: 'error',
                value: function () {
                  var e = o.default.slice(arguments)
                  this._add.apply(this, ['error'].concat(e))
                },
              },
              {
                key: 'warn',
                value: function () {
                  var e = o.default.slice(arguments)
                  this._add.apply(this, ['warn'].concat(e))
                },
              },
              {
                key: '_add',
                value: function (e, t) {
                  var r = this,
                    n = o.default.slice(arguments, 1)
                  if ((console[e].apply(null, n), n[1])) {
                    var i = []
                    n.forEach(function (e, r) {
                      1 === r ? i.push({ dt: t, dd: e }) : r > 1 && i.push(e)
                    }),
                      (t = i)
                  }
                  Array.isArray(t)
                    ? t.forEach(function (t) {
                        r._createAndInsertList(t, e)
                      })
                    : this._createAndInsertList(t, e)
                },
              },
              {
                  ...
                  if (e) {
                    ...
                    s
                      ...
                      ? e.dd
                        ...
                        : (n = e)
                      : ((n = e), (a = e.toString() + '::'))
                    var d = { tag: 'dl', attrs: { class: '__' + t }, child: [] }
                    r && d.child.push({ tag: 'dt', child: u(r) }),
                      o.default.isObject(n) ? (n = JSON.stringify(n, null, '\t')) : s || (n = a + n),
                      (n = u(n)),
                      d.child.push({ tag: 'dd', child: n }),
                      this.list.push(e)
                    var l = i.default.createVdom(d)
                    this.$list.appendChild(l), this.visible && this._toBottom()
                  }
                },
              },
              {
                ...
                value: function () {
                  ;(this.visible = !0),
                    ...
                    this._toBottom(),
                    this.opts.showSwitch && (this.$switch.style.display = 'none')
                },
              },
              {
                key: 'hide',
                value: function () {
                  ;(this.visible = !1),
                    ...
                    this.opts.showSwitch && (this.$switch.style.display = '')
                },
              },
              {
                key: 'clear',
                value: function () {
                  ;(this.list = []), (this.$list.innerHTML = ''), this.log('cleared')
                },
              },
              {
                key: 'destroy',
                value: function () {
                  var e = this.$wrapper,
                    t = this.$switch
                  this._initEvent(!0), e.parentNode.removeChild(e), t.parentNode.removeChild(t)
                },
              },
              {
                key: '_toBottom',
      ...
      function u(e) {
        return /^(data:.+?;base64).+/.test(e)
          ? RegExp.$1 + '...'
          : e.replace(/(?:(data:.+?;base64).+?)"/g, function (e, t) {
              return t + '..."'
            })
      }
      t.ZxDebug = d
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.default = {
          ...
          addEvent: function (e, t, r) {
            ...
            if (e && t && r)
              if (e.length) for (var i = 0; i < e.length; i++) e[i].addEventListener(t, r, n)
              else e.addEventListener(t, r, n)
          },
          removeEvent: function (e, t, r) {
            var n = arguments.length > 3 && void 0 !== arguments[3] && arguments[3]
            if (e && t && r)
              if (e.length) for (var i = 0; i < e.length; i++) e[i].removeEventListener(t, r, n)
    ...
    function (e, t, r) {
      ...
      ;(e.exports = r(6)(!1)).push([
        e.i,
        '.zxeditor-debug-switch{position:fixed;z-index:9999;right:20px;width:30px;height:30px;border-radius:50%;background-image:url(' +
          n(r(7)) +
          ');background-size:cover;-webkit-box-shadow:0 0 10px rgba(0,0,0,0.1);box-shadow:0 0 10px rgba(0,0,0,0.1)}@media (-webkit-min-device-pixel-ratio:3),(min-device-pixel-ratio:3){.zxeditor-debug-switch{background-image:url(' +
          n(r(8)) +
          ')}}.zxeditor-debug-wrapper{position:fixed;z-index:9999;left:0;bottom:0;width:100%;height:40%;background-color:rgba(0,0,0,0.7);}.zxeditor-debug-wrapper .zxeditor-debug-head{position:relative;height:30px;line-height:30px;-webkit-box-sizing:border-box;box-sizing:border-box;color:#ccc;background-color:rgba(0,0,0,0.8);}.zxeditor-debug-wrapper .zxeditor-debug-head span{padding-left:15px;font-size:14px;color:#eee}.zxeditor-debug-wrapper .zxeditor-debug-head i{font-size:10px;color:#adff2f;font-style:normal}.zxeditor-debug-wrapper .zxeditor-debug-head i.__close{position:absolute;top:0;right:0;padding:0 15px}.zxeditor-debug-wrapper .zxeditor-debug-body{overflow-y:auto;}.zxeditor-debug-wrapper .zxeditor-debug-body .zxeditor-debug-list dl{margin:0 auto;padding:5px 0;border-bottom:1px dashed #999;}.zxeditor-debug-wrapper .zxeditor-debug-body .zxeditor-debug-list dl:last-child{border-bottom:0}.zxeditor-debug-wrapper .zxeditor-debug-body .zxeditor-debug-list dl dt,.zxeditor-debug-wrapper .zxeditor-debug-body .zxeditor-debug-list dl dd{margin:0 15px;font-size:.8em}.zxeditor-debug-wrapper .zxeditor-debug-body .zxeditor-debug-list dl dt{font-weight:600;color:#fff}.zxeditor-debug-wrapper .zxeditor-debug-body .zxeditor-debug-list dl dd{color:#adff2f;word-break:break-all}.zxeditor-debug-wrapper .zxeditor-debug-body .zxeditor-debug-list .__error dd{color:#ff4141}.zxeditor-debug-wrapper .zxeditor-debug-body .zxeditor-debug-list .__warn dd{color:#ff0}',
        '',
      ])
    },
    function (e, t, r) {
    ...
    function (e, t, r) {
      ...
      function l(e, t) {
        for (var r = 0; r < e.length; r++) {
          ...
          if (o) {
            ...
            for (; a < i.parts.length; a++) o.parts.push(g(i.parts[a], t))
          } else {
            var s = []
            for (a = 0; a < i.parts.length; a++) s.push(g(i.parts[a], t))
      ...
      function h(e) {
        ...
        return (e.attrs.type = 'text/css'), b(t, e.attrs), f(e, t), t
      }
      function b(e, t) {
      ...
      function g(e, t) {
        ...
        if (t.singleton) {
          var d = s++
          ;(r = a || (a = h(t))), (n = x.bind(null, r, d, !1)), (i = x.bind(null, r, d, !0))
        } else
          e.sourceMap &&
          'function' == typeof URL &&
          ...
          'function' == typeof btoa
            ? ((r = (function (e) {
                ...
                return (e.attrs.type = 'text/css'), (e.attrs.rel = 'stylesheet'), b(t, e.attrs), f(e, t), t
              })(t)),
              (n = function (e, t, r) {
                var n = r.css,
                  i = r.sourceMap,
      ...
      e.exports = function (e) {
        ...
        return e.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function (e, t) {
          ...
          return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/)/i.test(o)
            ? e
            : ((i = 0 === o.indexOf('//') ? o : 0 === o.indexOf('/') ? r + o : n + o.replace(/^\.\//, '')),
