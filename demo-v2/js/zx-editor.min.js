 ...
 * Released on: 2020-10-23 18:47:07
 */
!(function (e, t) {
  ...
  return (function (e) {
    ...
    function (e, t, i) {
      ...
      function u(e, t) {
        for (var i = 0; i < e.length; i++) {
          ...
          if (n) {
            ...
            for (; a < r.parts.length; a++) n.parts.push(b(r.parts[a], t))
          } else {
            var l = []
      ...
      function h(e, t) {
        for (var i = [], r = {}, n = 0; n < e.length; n++) {
          ...
          r[a] ? r[a].parts.push(l) : i.push((r[a] = { id: a, parts: [l] }))
        }
        return i
      }
      function f(e, t) {
        ...
        if ('top' === e.insertAt)
          ...
          var n = l(e.insertInto + ' ' + e.insertAt.before)
          i.insertBefore(t, n)
        }
      }
      function g(e) {
      ...
      function m(e) {
        ...
        return (e.attrs.type = 'text/css'), x(t, e.attrs), f(e, t), t
      }
      function x(e, t) {
      ...
      function b(e, t) {
        ...
        if (t.singleton) {
          var a = c++
          ;(i = s || (s = m(t))), (r = w.bind(null, i, a, !1)), (n = w.bind(null, i, a, !0))
        } else
          e.sourceMap &&
          'function' == typeof URL &&
          ...
          'function' == typeof btoa
            ? ((i = (function (e) {
                ...
                return (e.attrs.type = 'text/css'), (e.attrs.rel = 'stylesheet'), x(t, e.attrs), f(e, t), t
              })(t)),
              (r = k.bind(null, i, t)),
              (n = function () {
      ...
      e.exports = function (e) {
        ...
        return e.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function (e, t) {
          ...
          return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/)/i.test(o)
            ? e
            : ((n = 0 === o.indexOf('//') ? o : 0 === o.indexOf('/') ? i + o : r + o.replace(/^\.\//, '')),
      ...
      'function' != typeof Object.assign &&
        Object.defineProperty(Object, 'assign', {
          value: function (e, t) {
            ...
            for (var i = Object(e), r = 1; r < arguments.length; r++) {
              var n = arguments[r]
              if (n) for (var o in n) Object.prototype.hasOwnProperty.call(n, o) && (i[o] = n[o])
            }
            return i
          },
          writable: !0,
        ...
        Array.prototype.forEach ||
          (Array.prototype.forEach = function (e, t) {
            ...
            for (arguments.length > 1 && (i = t), r = 0; r < o; ) {
              var a = void 0
              r in n && ((a = n[r]), e.call(i, a, r, n)), r++
            }
          }),
        Array.isArray ||
    ...
    function (e, t, i) {
      ...
      var r =
        ...
        n = {
          ...
          rgbToHex: function (e) {
            var t = ''
            return (
              /rgb.*?\((\d+)\D+?(\d+)\D+?(\d+)/.test(e) &&
                ((t += this.toHex(RegExp.$1)), (t += this.toHex(RegExp.$2)), (t += this.toHex(RegExp.$3))),
              t ? '#' + t : e
            )
          },
          isEmpty: function (e) {
          ...
          randStr: function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 'zxEditor_'
            return e + +new Date()
          },
          isObject: function (e) {
        ...
        s = {
          ...
          removeClass: function (e, t) {
            if (e && t)
              if (t.classList) t.classList.remove(e)
                ...
                var i = s.getClass(t, !0)
                if (0 !== i.length) {
                  for (var r = 0; r < i.length; r++) e === i[r] && i.splice(r, 1)
                  t.className = i.join(' ')
                }
              }
          },
          ...
          getClass: function (e, t) {
            if (e) {
              var i = n.trim(e.className)
              return t ? (i ? i.split(' ') : []) : i
            }
          },
          addEvent: function (e, t, i) {
            var r = arguments.length > 3 && void 0 !== arguments[3] && arguments[3]
            if (e && t && i)
              if (e.length) for (var n = 0; n < e.length; n++) c(e[n], t, i, r)
              else c(e, t, i, r)
          },
          removeEvent: function (e, t, i) {
            var r = arguments.length > 3 && void 0 !== arguments[3] && arguments[3]
            if (e && t && i)
              if (e.length) for (var n = 0; n < e.length; n++) d(e[n], t, i, r)
              else d(e, t, i, r)
          },
          createElm: function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 'div',
              t = arguments[1],
              i = l.createElement(e)
            if (t && t instanceof Object) for (var r in t) t.hasOwnProperty(r) && i.setAttribute(r, t[r])
            return i
          },
          createVdom: function (e) {
            ...
            var n = s.createElm(t || 'div', i)
            if (Array.isArray(r) && r.length) {
              var o = void 0
              r.forEach(function (e) {
                ;(o = s.createVdom(e)) && n.appendChild(o)
              })
            } else r && 'string' == typeof r && n.appendChild(l.createTextNode(r))
            return n
          },
          changeTagName: function (e, t) {
            ...
            var i = s.createElm(t),
              ...
              c = ''
            'ul' === r
              ? n.slice(e.children).forEach(function (e) {
                  c += e.innerHTML
                })
              : (c = 'blockquote' === r ? e.innerText : e.innerHTML)
            return (
              'blockquote' === t
                ? (c = '<p style="color: inherit">' + c + '</p>')
                : 'ul' === t && (c = '<li style="color: inherit">' + c + '</li>'),
              o && (i.className = o),
              a && (i.id = a),
              l && i.setAttribute('style', l),
              (i.innerHTML = c),
              (e = null),
              i
            )
          ...
          isEmptyInner: function (e, t) {
            e || n.err("Function 'isEmptyInner($el)', $el is " + e)
            var i = e.children
            return n.isEmpty(e.innerText) && (0 === i.length || 1 !== i[0].nodeType || 'BR' === i[0].nodeName)
          },
          ...
          query: function (e) {
            ...
            var i = s.queryAll(e, t)
            return i.length > 0 ? i[0] : null
          },
          queryAll: function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : l
            if ('function' == typeof l.querySelectorAll) return n.slice(t.querySelectorAll(e))
            var i = [],
              r = void 0
            if (/^#\w+$/.test(e)) (r = t.getElementById(e)) && i.push(r)
            else {
              var o = t.getElementsByTagName('*'),
                a = o.length
              if (/^\.(\w+)$/.test(e))
                for (var s = RegExp.$1, c = 0; c < a; c++) 1 === (r = o[c]).nodeType && xmq.hasClass(s, r) && i.push(r)
              else for (var d = e.toUpperCase(), p = 0; p < a; p++) (r = o[p]).nodeName === d && i.push(r)
            }
            return i
          },
          getStyle: function (e, t) {
            if (!s.isHTMLElement(e)) return null
            var i = a.getComputedStyle(e, null),
              r = null
            if (t)
              try {
                r = i[n.strToHump(t)]
          ...
          maxZIndex: function () {
            for (
              var e = l.getElementsByTagName('*'), t = void 0, i = void 0, r = void 0, o = [], a = 0;
              a < e.length;
              a++
            )
              1 === (t = e[a]).nodeType &&
                'static' !== (i = s.getStyle(t) || {}).position &&
                (r = n.int(i.zIndex)) > 0 &&
                o.push(r)
            return n.int(Math.max.apply(null, o))
          },
          insertAfter: function (e, t) {
            var i = e.nextElementSibling,
              r = e.parentNode
            null === i ? r.appendChild(t) : r.insertBefore(t, i)
          },
          insertToRangeElm: function (e, t, i, r) {
            var n = void 0
            if (
              (s.isEmptyInner(t, !0)
                ? (((n = t).innerHTML = ''), n.appendChild(e))
                : ((n = s.createElm('p')).appendChild(e), s.insertAfter(t, n)),
              i && (n.className = i),
              r)
            ) {
              var o = s.createElm('i', { class: '__remove' })
              n.setAttribute('contenteditable', !1), n.appendChild(o), (o = null)
            }
            var a = n.parentNode
            return a && a.lastElementChild === n ? s.insertParagraph(a) : n.nextElementSibling
          },
          siblings: function (e, t) {
            var i = [],
              r = [],
              o = n.slice(e.parentNode.children)
            if (
          ...
          data: function (e, t, i) {
            ...
            if (s.isHTMLElement(e)) {
              if (void 0 === i) return e.getAttribute('data-' + t)
              e.setAttribute('data-' + t, i)
            }
            return null
          },
          insertStr: function (e, t, i) {
            ...
            return (
              (t =
                null !== a.pageYOffset
                  ...
                  ? { left: o.documentElement.scrollLeft, top: o.documentElement.scrollTop }
                  : { left: o.body.scrollLeft, top: o.body.scrollTop }),
              'left' === e || 'top' === e ? t[e] : t
            )
          },
          scrollTop: function (e, t) {
            var i = s.getWindow(e)
            if (void 0 === t) return i ? i.pageYOffset : e.scrollTop
            i ? i.scrollTo(0, t) : (e.scrollTop = t)
          },
          removeHtmlTags: function (e) {
            return (e = e.toString().replace(/<\/?.*?>/g, '')), n.trim(e)
          },
      ...
      function c(e, t, i, r) {
        e.addEventListener ? e.addEventListener(t, i, r) : e.attachEvent ? e.attachEvent(t, i) : (e['on' + t] = i)
      }
      function d(e, t, i, r) {
      ...
      var p = s,
        ...
        h = function (e) {
          ...
          if (t)
            for (var i = Array.prototype.slice.call(arguments, 1), r = 0; r < t.length; r++)
              try {
                t[r].apply(null, i)
              } catch (t) {
            ...
            m(e, [
              ...
              },
              {
                ...
                value: function (e, t, i) {
                  ...
                  if (
                    (t && 'object' === (void 0 === t ? 'undefined' : g(t)) && (t = JSON.stringify(t)),
                    !t || '{}' === t || '[]' === t)
                  )
              ...
              },
              {
                key: 'remove',
                value: function (e, t) {
                  ;(e = this._key(e)) && b(t).removeItem(e)
                },
              },
            ]),
            e
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  null === this.selection ? this.init() : this.selection.removeAllRanges(),
                    (this.offset = n.int(t)),
                    e && this.range.setStart(p.getTextNode(e), this.offset),
                    this.range.collapse(!0),
                    this.timer && (clearTimeout(this.timer), (this.timer = null)),
                    (this.timer = setTimeout(function () {
                      i.selection.addRange(i.range)
                    }, 100))
                },
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    w(this.range.endContainer, this.$content) ||
                    this.$content.lastElementChild ||
                    p.insertParagraph(this.$content)
                  )
                },
              },
            ]),
      ...
      var z = { maskOpacity: 0.3, confirmBtnColor: '', cancelBtnColor: '' },
        R = (function () {
          function e() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
            E(this, e),
              (this.visible = !1),
              (this.opts = Object.assign({}, z, t)),
              (this.ids = []),
              (this.$loadings = []),
              this._init(),
              (this.version = '2.5.4')
          ...
          return (
            k(e, [
                  ...
                  var n = this.opts,
                    ...
                    a = {
                      attrs: {
                        ...
                        style: 'background:rgba(0,0,0,' + n.maskOpacity + ');z-index:' + o + ';',
                      },
                      child: [{ attrs: { class: 'zx-dialog-inner' }, child: i }],
                    },
                    l = p.createVdom(a),
                    s = p.query('body')
                  if (s) {
                    p.lock(s), s.appendChild(l)
                    var c = p.query('.__confirm', l),
                      d = p.query('.__cancel', l)
                    p.addEvent(c, 'click', function (e) {
                      r.emit(t, !0), r.destroy(l, t)
                    }),
                      p.addEvent(d, 'click', function (e) {
                        r.emit(t, !1), r.destroy(l, t)
                      })
                  }
                  return l
                },
              },
              {
                ...
                value: function (e, t) {
                  var i = this.opts,
                    r = n.randStr('zxDialog_'),
                    o = []
                  o.push({ attrs: { class: 'zx-dialog-message' }, child: e || 'not message!' }),
                    o.push({
                      attrs: { class: 'zx-dialog-footer' },
                      child: [
                        {
                          tag: 'span',
                          attrs: { class: '__confirm', style: i.confirmBtnColor ? 'color:' + i.confirmBtnColor : '' },
                          child: '确定',
                        },
                      ],
                    }),
                    this._createDialog('alert', r, o),
                    'function' == typeof t && this.on(r, t)
                },
              },
              {
                key: 'confirm',
                value: function (e, t) {
                  var i = this.opts,
                    r = n.randStr('zxDialog_'),
                    o = []
                  o.push({ attrs: { class: 'zx-dialog-message' }, child: e || '无提示内容' }),
                    o.push({
                      attrs: { class: 'zx-dialog-footer' },
                      child: [
                        {
                          tag: 'span',
                          attrs: { class: '__cancel', style: i.cancelBtnColor ? 'color:' + i.cancelBtnColor : '' },
                          child: '取消',
                        },
                        {
                          tag: 'span',
                    ...
                    this._createDialog('confirm', r, o),
                    'function' == typeof t && this.on(r, t)
                },
              },
              {
                key: 'loading',
                value: function (e) {
                  var t = n.randStr('zxDialog_'),
                    i = [{ attrs: { class: 'zx-dialog-message' }, child: e || 'loading ...' }],
                    r = this._createDialog('loading', t, i)
                  this.$loadings.push(r)
                },
              },
              {
                key: 'removeLoading',
                value: function () {
                  for (var e = void 0; this.$loadings.length; )
                    (e = this.$loadings.pop()).parentNode && e.parentNode.removeChild(e)
                  p.unlock()
                },
              },
              {
                key: 'removeAll',
                value: function () {
                  var e = p.queryAll('.zx-dialog-wrapper')
                  if (e.length > 0) {
                    var t = void 0,
                      i = void 0
                    for (t = 0; t < e.length; t++) (i = e[t]), this.destroy(i, i.id)
                  }
      ...
      ;(R.prototype.on = u), (R.prototype.emit = h), (R.prototype.off = f)
      var I = R,
        S = {
          autoSave: 0,
          fixed: !1,
      ...
      var T = ['p', 'h2', 'h4', 'ul', 'blockquote'],
        C = { img: '图片', a: '链接', video: '视频', audio: '音频' }
      function M(e) {
        var t = e.cursor,
          i = e.$content
        p.addEvent(i, 'click', function (r) {
          r.stopPropagation(), e.emit('click', i, r), e.emojiModal.hide(), e.textstyleModal.hide()
          var n = r.target,
            o = n.nodeName
          if (('A' === o && r.preventDefault(), 'I' === o && n.className.indexOf('__remove') >= 0))
            return (
              r.preventDefault(),
              void (function (r) {
                var n = w(r, i),
                  o = (n ? n.className : '').replace(/child-node-is-(\w+)/, '$1'),
                  a = C[o]
                e.emit('debug', 'Delete ' + a),
                  e.dialog.confirm('您确定要删除' + a + '吗？', function (i) {
                    if (i) {
                      if (n) {
                        e.emit('remove-attach', n, o)
                        var r = n.nextElementSibling || n.previousElementSibling
                        n.parentNode.removeChild(n), t.setRange(r, 0)
                      }
                      e.emit('change', 'content', e)
                    }
                    n = null
                  })
              })(n)
          ...
          r.currentTarget === i &&
            (!(function () {
              if (p.isEmptyInner(i)) {
                var r = p.createElm('p')
                ;(r.innerHTML = '<br>'), i.appendChild(r), r.focus(), e.emit('change', 'content', e), (e.$cursorElm = r)
              } else e.$cursorElm = t.getRange()
            })(),
            N(i))
        }),
          p.addEvent(i, 'keydown', function (t) {
            8 === t.keyCode &&
              (e.options.disableBackspaceDelete &&
                (function (t) {
                  var r = void 0,
                    n = void 0
                  try {
                    ;(r = w(e.$cursorElm, i)), (n = r.previousElementSibling)
                  } catch (t) {}
                  if (!n) return
                  ;(p.query('a', n) || p.query('img', n) || p.query('video', n) || p.query('audio', n)) &&
                    0 === e.cursor.offset &&
                    t.preventDefault()
                })(t),
              U(i) && t.preventDefault())
          }),
          p.addEvent(i, 'focus', function (t) {
            e.emit('focus', i), N(i)
          }),
          p.addEvent(i, 'blur', function (r) {
            e.emit('blur', i),
              (e.$cursorElm = t.getRange()),
              (function (e) {
                n.isEmpty(e.innerText) && !p.query('img', e) ? p.addClass('is-empty', e) : N(e)
              })(i),
              e.$cursorElm && !e.$cursorElm.innerHTML && (e.$cursorElm.innerHTML = '<br>'),
              (function () {
                var t = w(e.$cursorElm, i)
                if (t) {
                  var r = t.className
                  if (r) {
                    var n = r.replace(/child-node-is-(\w+)/gi, '$1')
                    n && !p.query(n, t) && (t.removeAttribute('class'), t.removeAttribute('contenteditable'))
                  }
                  var o = t.nodeName.toLowerCase()
                  if (-1 === T.indexOf(o)) {
                    var a = p.changeTagName(t, 'p')
                    i.replaceChild(a, t)
                  }
                  e.emit('change', 'content', e)
                }
          ...
          p.addEvent(
            ...
            'keyup',
            function (i) {
              ;(e.$cursorElm = t.getRange()), e.checkCursorPosition(), e.emit('change', 'content', e)
            },
            !1,
          ),
          p.addEvent(i, 'paste', function (t) {
            t.preventDefault()
            ...
            if (r) {
              ...
              a &&
                (function () {
                  var t = function (t) {
                      l++,
                        ...
                        l === r &&
                          (function (t) {
                            if (t) {
                              t = p.removeHtmlTags(t)
                              var r = o.createTextNode(t)
                              e.insertElm(r, 'text')
                              var n = setTimeout(function (t) {
                                e.checkCursorPosition(), clearTimeout(n), (n = null)
                              }, 350)
                            } else e.dialog.alert('剪贴板无有效的文本内容')
                            e.emit('paste', i, { content: t }), e.emit('change', 'content', e)
                          })(s)
                    },
                    r = a.length,
                    l = 0,
                  ...
                  for (c = 0; c < r; c++)
                    (d = a[c]),
                      /^text\/plain/.test(d.type)
                        ? d.getAsString(function (e) {
                            t(e)
                          })
                        : t('')
                })()
      ...
      function N(e) {
        p.hasClass('is-empty', e) && p.removeClass('is-empty', e)
      }
      function U(e) {
        return e.children.length <= 1 && n.isEmpty(e.innerText)
      }
      var B = (function () {
        function e(e, t) {
          for (var i = 0; i < t.length; i++) {
      ...
      var Y = {
        ...
        j = (function () {
          function e() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
            G(this, e),
              (this.opts = Object.assign({}, Y, t)),
              (this.height = n.int(this.opts.height)),
            ...
            B(e, [
              {
                ...
                value: function (e) {
                  var t = e.$parent,
                    i = n.int(e.headHeight),
                    r = n.int(e.height)
                  if (t && p.isHTMLElement(t)) {
                    var o = e.bodyChildVnode,
                      a = {
                        tag: 'div',
                        attrs: {
                          class: 'zxeditor-modal-wrapper ' + e.classHook,
                          style: 'transform:translateY(' + (e.visible ? 0 : '100%') + ');height:' + r + 'px',
                        },
                        child: [
                          {
                            attrs: { class: 'zxeditor-modal-head', style: 'height: ' + i + 'px;' },
                            child: [
                              { tag: 'span', attrs: { class: '__title' }, child: e.headTitle },
                              { attrs: { class: '__switch', style: 'height: ' + i + 'px;' }, child: e.headSwitch },
                            ],
                          },
                          {
                            attrs: { class: 'zxeditor-modal-body', style: 'height:' + (r - i) + 'px;' },
                            child: Array.isArray(o) ? o : [o],
                          },
                        ],
                      }
                    ;(this.$modal = p.createVdom(a)),
                      t.appendChild(this.$modal),
                      (this.$switch = p.query('.__switch', this.$modal)),
                      (this.$body = p.query('.zxeditor-modal-body', this.$modal)),
                      this._initEvent()
              ...
              },
              {
                ...
                value: function () {
                  var e = p.query('body'),
                    t = this.$body
                  p.addEvent(this.$modal, 'click', function (e) {
                    e.stopPropagation()
                  }),
                    p.addEvent(t, 'touchstart', function (t) {
                      !0, p.lock(e)
                    }),
                    p.addEvent(t, 'touchmove', function (e) {}),
                    p.addEvent(t, 'touchend', function (t) {
                      !1
                      var i = setTimeout(function (t) {
                        p.unlock(e), clearTimeout(i), (i = null)
                      }, 300)
                    })
                },
              },
              {
                ...
                value: function () {
                  this.visible ||
                    ((this.$modal.style.transform = 'translateY(0)'), (this.visible = !0), this.opts.onShow())
                },
              },
              {
                key: 'hide',
                value: function () {
                  this.visible &&
                    ((this.$modal.style.transform = 'translateY(100%)'), (this.visible = !1), this.opts.onHide())
                },
              },
            ]),
            e
      ...
      function D(e) {
        ...
        var i = new j({
          ...
          onShow: function () {
            e.emit('bottom-modal', { type: 'emoji', show: !0, height: i.height }),
              e.resetContentPostion(i.height),
              e.checkCursorPosition()
          },
          onHide: function () {
            e.emit('bottom-modal', { type: 'emoji', show: !1, height: 0 }),
              e.resetContentPostion(e.toolbarHeight),
              e.checkCursorPosition()
          },
        })
        ;(e.emojiModal = i),
          p.addEvent(i.$body, 'click', function (t) {
            var i = t.target
            'I' === i.nodeName &&
              (function (t) {
                var i = e.cursor.offset
                try {
                  ;(e.$cursorElm.innerHTML = p.insertStr(e.$cursorElm.innerText, t, i)),
                    e.cursor.setRange(e.$cursorElm, i + 2),
                    e.checkCursorPosition()
                } catch (t) {
          ...
          p.addEvent(i.$switch, 'click', function (e) {
            i.hide()
          })
      }
      var Q = '#d0d0d0',
      ...
      function V(e) {
        var t = {
            ...
            child: [
              {
                ...
                child: [
                  { attrs: { class: 'text-bold', 'data-style': 'fontWeight:800' }, child: 'B' },
                  { attrs: { class: 'text-italic', 'data-style': 'fontStyle:italic' }, child: 'I' },
              ...
              },
              {
                ...
                child: [
                  { tag: 'dd', attrs: { class: 'active __black', 'data-color': '' } },
                  { tag: 'dd', attrs: { class: '__gray', 'data-color': Q } },
                  { tag: 'dd', attrs: { class: '__red', 'data-color': Z } },
                  { tag: 'dd', attrs: { class: '__yellow', 'data-color': J } },
                  { tag: 'dd', attrs: { class: '__green', 'data-color': P } },
                  { tag: 'dd', attrs: { class: '__blue', 'data-color': L } },
                  { tag: 'dd', attrs: { class: '__purple', 'data-color': H } },
                ],
              },
              {
                attrs: { class: '__tag-wrapper' },
                child: [
                  { attrs: { class: '__h2', 'data-tag': 'h2' }, child: ['大标题', { tag: 'i' }] },
                  { attrs: { class: '__h4', 'data-tag': 'h4' }, child: ['小标题', { tag: 'i' }] },
                  {
                    attrs: { class: '__p', 'data-tag': 'p' },
          ...
          i = new j({
            ...
            onShow: function () {
              e.emit('bottom-modal', { type: 'text-style', show: !0, height: i.height }),
                (function () {
                  if (!r) return
                  var t = e.$cursorElm.tagName.toLowerCase()
                  u.forEach(function (e) {
                    p.data(e, 'tag') === t ? h(e) : f(e)
                  })
                  var i = e.$cursorElm.style.color
                  ;/rgb\(/.test(i) && (i = n.rgbToHex(i))
                  c.forEach(function (e) {
                    p.data(e, 'color') === i ? p.addClass('active', e) : p.removeClass('active', e)
                  }),
                    e.cursor.setRange()
                })(),
                e.resetContentPostion(i.height),
            ...
            onHide: function () {
              e.emit('bottom-modal', { type: 'text-style', show: !1, height: 0 }),
                e.resetContentPostion(e.toolbarHeight),
                e.checkCursorPosition()
            },
          })
        e.textstyleModal = i
        var r = i.$body,
          o = p.query('.__style-wrapper', r),
          a = n.slice(o.children)
        function l(t) {
          var i = t.currentTarget.getAttribute('data-style').split(':'),
            r = i[0]
          e.$cursorElm.style[r] === i[1] ? (e.$cursorElm.style[r] = '') : (e.$cursorElm.style[r] = i[1]),
            e.cursor.setRange()
        }
        o &&
          (function () {
            for (var e = 0; e < a.length; e++) p.addEvent(a[e], 'click', l)
          })()
        var s = p.query('.__color-wrapper', r),
          c = n.slice(s.children)
        s &&
          p.addEvent(c, 'click', function (t) {
            var i = t.currentTarget,
              r = p.data(i, 'color')
            ;(e.$cursorElm.style.color = r),
              p.addClass('active', i),
              (p.siblings(i, 'active') || []).forEach(function (e) {
                p.removeClass('active', e)
              }),
              e.cursor.setRange()
          })
        var d = p.query('.__tag-wrapper', r),
          u = n.slice(d.children)
        function h(e) {
          var t = p.query('i', e)
          p.hasClass('checked', t) || p.addClass('checked', t)
        }
        function f(e) {
          var t = p.query('i', e)
          p.hasClass('checked', t) && p.removeClass('checked', t)
        }
        d &&
          p.addEvent(u, 'click', function (t) {
            var i = t.currentTarget
            if (p.query('.checked', i)) return
            h(i),
              (p.siblings(i) || []).forEach(function (e) {
                f(e)
              }),
              (r = i),
              (n = p.data(r, 'tag')),
              (o = p.changeTagName(e.$cursorElm, n)),
              e.$content.replaceChild(o, e.$cursorElm),
              (e.$cursorElm = o),
      ...
      var F = ['pic', 'emoji', 'text', 'link'],
        W = Object.create(null)
      function K(e) {
        var t = e.options.showToolbar,
          i = Array.isArray(t) ? t : t ? F : [],
          r = {
            tag: 'div',
            attrs: { class: 'zxeditor-toolbar-wrapper', style: i.length ? '' : 'display:none;' },
            child: [{ tag: 'dl', child: X(i) }],
          }
        ;(e.$toolbar = p.createVdom(r)),
          e.$editor.appendChild(e.$toolbar),
          (function (e) {
            var t = p.query('dl', e),
              i = t.children
            if (!i[0]) return
            var r = i[0].offsetWidth * i.length
            t.style.width = r + 'px'
          })(e.$toolbar)
        var o = p.queryAll('dd', e.$toolbar)
        o.length &&
          p.addEvent(o, 'click', function (t) {
            var i = t.currentTarget,
              r = p.data(i, 'on'),
              n = p.data(i, 'name')
            switch ((e.emit('debug', 'toolbarClick:', r), n)) {
              case 'pic':
                e.broadcast[r] ? e.emit(r) : a && a.click()
                break
              case 'emoji':
                e.emojiModal.show()
                break
              ...
              case 'link':
                e.broadcast[r]
                  ? e.emit(r, function (t, i) {
                      e.addLink(t, i)
                    })
                  : (e.$link.style.display = 'flex')
                break
              case 'split':
                p.insertHr(e.$cursorElm)
            }
          }),
          p.addEvent(e.$toolbar, 'click', function (e) {
            e.stopPropagation()
          })
        var a = (function () {
          if (e.broadcast['select-picture']) return null
          var t = p.createVdom({ tag: 'input', attrs: { style: 'display: none', type: 'file', accept: 'image/*' } })
          return (
            e.$wrapper.appendChild(t),
            p.addEvent(t, 'change', l),
            p.addEvent(t, 'click', function (e) {
              e.target.value = ''
            }),
            t
          )
        ...
        function l(t) {
          ...
          var i = this.files,
            r = n.slice(i)
          e.emit('debug', '选中的文件', r),
            e.filesToBase64(r, { width: 640 }, function (t, i) {
        ...
        return (
          e.forEach(function (e) {
            ;(i = W[e]) &&
              t.push({
                tag: 'dd',
                attrs: { class: '' + i.class, 'data-name': i.name, 'data-on': i.on },
                child: [{ tag: 'i', attrs: { class: i.icon } }],
              })
          }),
          t
        )
      }
      ;(W.pic = { name: 'pic', class: '__pic', icon: '', on: 'select-picture' }),
        (W.emoji = { name: 'emoji', class: '__emoji', icon: '', on: 'show-emoji' }),
        (W.text = { name: 'text', class: '__text', icon: '', on: 'show-textstyle' }),
        (W.link = { name: 'link', class: '__link', icon: '', on: 'add-link' })
      var q = ['img', 'audio', 'video']
      function _(e) {
        var t = void 0,
          i = void 0
        if (!/^data:(\w+\/\w+);base64,(.+)/.test(e))
          return console.error('toBlobData(data), "' + e + '" is not base64 data!'), null
        ;(t = RegExp.$1), (i = RegExp.$2)
        for (var r = a.atob(i), n = new Uint8Array(r.length), o = 0; o < r.length; o++) n[o] = r.charCodeAt(o)
      ...
      function ee(e, t) {
        ...
        return (
          (i.width = t.cw),
          (i.height = t.ch),
          i.getContext('2d').drawImage(e, t.sx, t.sy, t.sw, t.sh, 0, 0, i.width, i.height),
          i
        )
      }
      function te(e, t) {
          ...
          ie(e, [
            {
              ...
              value: function (e, t) {
                ...
                ;(this.version = '2.5.4'),
                  (this.broadcast = {}),
                  (function (e, t, i) {
                    'undefined' == typeof FileReader && e.emit('error', { msg: 'FileReader is undefined!' }),
                      'undefined' == typeof localStorage && e.emit('error', { msg: 'localStorage is undefined!' }),
                      (t && 'string' == typeof t) || n.err("selector is '" + t + "', is not valid"),
                      (e.$wrapper = p.query(t)),
                      null === e.$wrapper && n.err("Cann't found '" + t + "' Node in document!")
                    var r = Object.assign({}, S, i)
                    ;(e.id = n.randStr()),
                      (e.dialog = new I()),
                      ...
                      (e.toolbarHeight = 48),
                      (e.saveTimer = null),
                      i.autoSave > 0 && e.autoSave(n.int(i.autoSave)),
                      (e.storage = new y())
                    var o = '',
                      a = n.int(r.padding),
                      l = 'padding-left:' + a + 'px;padding-right:' + a + 'px'
                    o = r.fixed ? 'top:' + n.int(r.top) + 'px;bottom:' + n.int(r.bottom) + 'px;' + l : l
                    var s = {
                      tag: 'div',
                      attrs: { class: 'zxeditor-container' + (r.fixed ? ' fixed' : '') },
                      child: [
                        {
                          tag: 'div',
                    ...
                    ;(e.$editor = p.createVdom(s)),
                      (e.$content = p.query('.zxeditor-content-wrapper', e.$editor)),
                      r.showToolbar && e.resetContentPostion(r.bottom + 48),
                      e.$wrapper.appendChild(e.$editor),
                      (function (e) {
                        var t = e.storage.get('content')
                        t && e.setContent(t)
                      })(e),
                      (e.cursor = new A(e.$content)),
                  ...
                  (function (e) {
                      ...
                      child: [
                        {
                          ...
                          child: [
                            { attrs: { class: 'linkinput-title' }, child: '添加链接' },
                            {
                            ...
                            },
                            {
                              ...
                              child: [
                                { tag: 'button', attrs: { class: 'cancel-hook' }, child: '取消' },
                                { tag: 'button', attrs: { class: 'submit-hook disabled' }, child: '确定' },
                              ],
                            },
                          ],
                        },
                    ...
                    ;(e.$link = p.createVdom(t)), e.$editor.appendChild(e.$link)
                    var i = p.query('.submit-hook', e.$link),
                      r = p.query('.cancel-hook', e.$link),
                      o = p.queryAll('input', e.$link)
                    p.addEvent(
                      i,
                      'click',
                      function (t) {
                        var i = t.currentTarget
                        if (!p.hasClass('disabled', i)) {
                          var r = o[0].value,
                            n = o[1].value
                          r && (e.addLink(r, n), (e.$link.style.display = 'none'))
                        }
                      },
                      !1,
                    ),
                      ...
                      p.addEvent(
                        ...
                        function (e) {
                          var t = o[0].value
                          n.isHttpUrl(t) && p.hasClass('disabled', i) && p.removeClass('disabled', i)
                        },
                        !1,
                      )
                  })(this),
                  M(this),
                  ((i = this).keyboard = { height: 0 }),
                  (i.setKeyboard = function (e) {
                    var t = !1
                    if (n.isObject(e)) for (var r in e) e.hasOwnProperty(r) && ((i.keyboard[r] = e[r]), (t = !0))
                    t &&
                      (i.resetContentPostion(i.keyboard.height, i.toolbarHeight),
                      i.emit('message', { msg: 'Property keyboard has been updated!' }))
                  }),
              ...
              value: function (e, t) {
                ...
                if (e) {
                  ;(t = t || e.nodeName.toLowerCase()),
                    (this.$cursorElm = p.insertToRangeElm(e, this.$cursorElm, 'child-node-is-' + t, r)),
                    this.cursor.setRange(this.$cursorElm, 0)
                  var n = setTimeout(function (e) {
                    i.checkCursorPosition(), clearTimeout(n), (n = null)
                  }, 350)
            ...
            },
            {
              key: 'addMedia',
              value: function (e, t) {
                if ((this.emit('debug', 'addMedia start', e), t))
                  if (-1 !== q.indexOf(t)) {
                    var i = (function (e, t) {
                      var i = { src: t, width: '100%', height: 'auto', id: n.randStr('zxeditor_' + e + '_') }
                      return 'img' !== e && (i.controls = !0), p.createElm(e, i)
                    })(t, e)
                    this.insertElm(i, t, !0)
                  } else this.emit('error', { msg: 'Media type "' + t + '" is not valid!' })
                else this.emit('error', { msg: 'Unknown media type' })
              },
            },
            {
              key: 'addImage',
            ...
            },
            {
              ...
              value: function (e) {
                ...
                var t = []
                if (n.isObject(e)) t.push(e)
                else {
                  if (!Array.isArray(e)) return void this.emit('error', { msg: 'addFooterButton failure', data: t })
                  t = e
                }
            ...
            },
            {
              ...
              value: function (e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
                  i = this.options.fixed,
                  r = i ? 'bottom' : 'marginBottom'
                this.$content.style[r] = e + n.int(t) + 'px'
              },
            },
            {
              key: 'getBase64Images',
              value: function () {
                for (var e = [], t = p.queryAll('img', this.$content), i = void 0, r = void 0, n = 0; n < t.length; n++)
                  (r = (i = t[n]).src), /^data:.+?;base64,/.test(r) && e.push({ id: i.id, base64: r, blob: _(r) })
                return e
              },
            },
            {
              key: 'setImageSrc',
              value: function (e, t) {
                var i = p.query('#' + e, this.$content)
                return !!i && ((i.src = t), i.removeAttribute('id'), this.emit('change', 'content', this), !0)
              },
            },
            {
              key: '_visiblePostion',
              value: function () {
                var e = a.innerHeight,
                  ...
                  r = 0
                r =
                  this.emojiModal && this.emojiModal.visible
                    ? this.emojiModal.height
                    : this.textstyleModal && this.textstyleModal.visible
                    ? this.textstyleModal.height
                    : n.int(t.bottom) + (t.showToolbar ? this.toolbarHeight : 0)
                var o = { fixed: t.fixed, winHeight: e, startY: i, endY: e - r - i - n.int(this.keyboard.height) }
              ...
              value: function () {
                ...
                if (!e.fixed) {
                  ...
                  if (t) {
                    ...
                    this.emit('message', '编辑器光标元素位置参数', i)
                    var r = p.getScroll('top'),
                      n = 0
                    i.top < e.startY && ((n = r - (e.startY - i.top) - 10), p.scrollTop(a, n)),
                      i.bottom > e.endY && ((n = r + e.endY + 10), p.scrollTop(a, n))
                  }
                }
              },
            },
            ...
            },
            {
              ...
              value: function () {
                ...
                if (e) return this.$content.innerText
                var t = this.$content.childNodes,
                  i = void 0,
                  r = void 0
                for (i = 0; i < t.length; i++)
                  if (3 === (r = t[i]).nodeType) {
                    var o = n.trim(r.nodeValue)
                    if (o) {
                      var a = p.createElm('p')
                      ;(a.innerText = o), this.$content.replaceChild(a, r)
                    }
                  }
            ...
            },
            {
              ...
              value: function (e) {
                ...
                'number' != typeof e ||
                  e <= 0 ||
                  (this.saveTimer = setInterval(function (e) {
                    t.save()
                  }, 1e3 * e))
              },
            },
            ...
            },
            {
              ...
              value: function () {
                var e = this
                Object.keys(this.broadcast).forEach(function (t) {
                  e.off(t)
                }),
      ...
      for (var ne in ((re.prototype.on = u),
      (re.prototype.off = f),
      (re.prototype.emit = h),
      (re.prototype.toBlobData = _),
      (re.prototype.filesToBase64 = function (e, t, i) {
        if (e) {
          var r = e.length
          if (r) {
            void 0 === i && 'function' == typeof t && ((i = t), (t = {}))
            var o = 10
            try {
              o = n.int(this.options.imageMaxSize)
            } catch (e) {}
            o *= 1048576
            var a = 0,
              l = [],
            ...
            for (c = 0; c < r; c++)
              (d = e[c]).size > o
                ? (l.push({
                    msg: 'files[' + c + ']: "' + d.name + '" size is beyond the ' + this.options.imageMaxSize + 'MB!',
                  }),
                  h())
                : 'undefined' == typeof EXIF
                ? ((t.orientation = 0), u(d))
                : EXIF.getData(d, function () {
                    var e = EXIF.getAllTags(this) || {}
                    ;(t.orientation = e.Orientation), u(d)
                  })
            e = null
          } else i([{ msg: "files's length is " + r }])
        } else i([{ msg: 'files is not valid. is ' + e }])
        function u(e) {
          !(function (e, t, i) {
                ...
                ;/^data:image\//i.test(r)
                  ? ((t.type = e.type),
                    ...
                    (function (e, t, i) {
                      var r = new Image()
                      ;(r.src = e),
                        r.setAttribute('alt', t.name),
                        (r.onload = function (n) {
                          if ('image/gif' !== t.type || !0 === t.clip) {
                            var o = (function (e, t) {
                              var i = p.createElm('canvas'),
                                r = i.getContext('2d'),
                                n = (i.width = e.width),
                                o = (i.height = e.height)
                              if (t.orientation > 1)
                                switch (t.orientation) {
                                  case 6:
                                    ;(i.width = o), (i.height = n), r.rotate(Math.PI / 2), r.drawImage(e, 0, -o, n, o)
                                    break
                                  case 3:
                                    r.rotate(Math.PI), r.drawImage(e, -n, -o, n, o)
                                    break
                                  case 8:
                                    ;(i.width = o),
                                      (i.height = n),
                                      r.rotate((3 * Math.PI) / 2),
                                      r.drawImage(e, -n, 0, n, o)
                                }
                              else r.drawImage(e, 0, 0, n, o)
                              return {
                                element: i,
                                data: i.toDataURL(t.type),
                                width: i.width,
                                height: i.height,
                                type: t.type,
                                size: t.size,
                        ...
                        ? (function (e, t, i) {
                            var r = e.type,
                              o = (function (e, t, i) {
                                var r = n.int(i.width),
                                  o = n.int(i.height)
                                if (!i.clip && r > 0 && e < r && o > 0 && t < o)
                                  return { sx: 0, sy: 0, sw: e, sh: t, scaling: 1, cw: e, ch: t }
                                var a = 1,
                                  l = 0,
                                  s = 0,
                                  c = e,
                                  ...
                                  ? ((c = r),
                                    ...
                                    u >= o
                                      ...
                                      : ((a = te(t, o)),
                                        ...
                                        (s = 0)))
                                  : r > 0
                                  ? ((a = te(e, r)), (c = r), (d = Math.floor((r * t) / e)))
                                  : o > 0 && ((a = te(t, o)), (c = Math.floor((o * e) / t)), (d = o))
                                return { sx: l, sy: s, sw: n.int(c * a), sh: n.int(d * a), scaling: a, cw: c, ch: d }
                              })(e.width, e.height, t),
                              a = e.element,
                              l = 2,
                              s = o.sw,
                            ...
                            if (o.scaling > l) {
                              l = o.scaling
                              do {
                                ;(a = ee(a, { cw: o.cw * l, ch: o.ch * l, sx: d, sy: p, sw: s, sh: c })),
                                  (s = a.width),
                                  (c = a.height),
                                  (d = p = 0),
                                  (l -= 1)
                            ...
                            var u = (a = ee(a, { cw: o.cw, ch: o.ch, sx: d, sy: p, sw: s, sh: c })).toDataURL(r),
                              h = _(u)
                            i(null, {
                              element: a,
                              type: r,
                    ...
                    (e = null))
                  : i({ msg: '"' + e.name + '" is not Image File!' })
              }),
              (r.onerror = function (t) {
                i({ msg: 'Error, FileReader "' + e.name + '"!', data: t }), (e = null)
              })
          })(e, t, function (e, t) {
            e ? l.push(e) : t && s.push(t), h()
          })
        }
        function h() {
          a++, r === a && i(l.length ? l : null, s.length ? s : null)
        }
      }),
      p))
        p.hasOwnProperty(ne) && (re.prototype[ne] = p[ne])
      for (var oe in n) n.hasOwnProperty(oe) && (re.prototype[oe] = n[oe])
    },
  ])
})
