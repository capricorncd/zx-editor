...
;(function (global, factory) {
   ...
   * Released on: Sat May 14 2022 11:19:43 GMT+0900 (Japan Standard Time)
  ...
  var setContentValueOfPseudoElementBefore = function setContentValueOfPseudoElementBefore(placeholder) {
    ...
    // 为伪类content设值
    var beforeStyle = '.'
      .concat(CLASS_NAME_EDITOR, ' .')
      .concat(CLASS_NAME_CONTENT, ".is-empty:before{content:'")
      .concat(placeholder, "' !important;") // 生成style元素
    ...
    if (oldNodeName === 'LI' && isUlElement(parent)) {
      ...
      if (parent.childElementCount > 1) {
        ...
        if (parent.firstElementChild === input) {
          ...
          // 将新元素移动至UL/OL前面
          ;(_parent$parentElement = parent.parentElement) === null || _parent$parentElement === void 0
            ? void 0
            : _parent$parentElement.insertBefore(newEl, parent)
        } // 当前LI元素为UL的最后一个元素
        else if (parent.lastElementChild === input) {
          var _parent$parentElement2

          var parentNext =
            (_parent$parentElement2 = parent.parentElement) === null || _parent$parentElement2 === void 0
              ? void 0
              : _parent$parentElement2.nextElementSibling // 下一个兄弟元素存在，添加至下一个兄弟元素前面

          if (parentNext) {
            var _parentNext$parentEle

            ;(_parentNext$parentEle = parentNext.parentElement) === null || _parentNext$parentEle === void 0
              ? void 0
              : _parentNext$parentEle.insertBefore(newEl, parentNext)
          } else {
            var _parent$parentElement3

            // 下一个兄弟元素不存在，添加至内容尾部
            ;(_parent$parentElement3 = parent.parentElement) === null || _parent$parentElement3 === void 0
              ? void 0
              : _parent$parentElement3.append(newEl)
          }
          ...
          ;(_parent$parentElement4 = parent.parentElement) === null || _parent$parentElement4 === void 0
            ? void 0
            : _parent$parentElement4.insertBefore(prevEl, parent) // 将新元素插入到当前UL/OL元素前面

          ;(_parent$parentElement5 = parent.parentElement) === null || _parent$parentElement5 === void 0
            ? void 0
            : _parent$parentElement5.insertBefore(newEl, parent) // 删除被替换的对象元素
        ...
        // 将新元素移动至UL/OL前面
        ;(_parent$parentElement6 = parent.parentElement) === null || _parent$parentElement6 === void 0
          ? void 0
          : _parent$parentElement6.insertBefore(newEl, parent) // 移除UL/OL空元素

        ;(_parent$parentElement7 = parent.parentElement) === null || _parent$parentElement7 === void 0
          ? void 0
          : _parent$parentElement7.removeChild(parent)
      }
      ...
      if (/UL|OL/.test(newNodeName)) {
        ...
        if (prev && isUlElement(prev)) {
          ...
          if (next && next.nodeName === prev.nodeName) {
            ...
            ;(_next$parentElement = next.parentElement) === null || _next$parentElement === void 0
              ? void 0
              : _next$parentElement.removeChild(next)
          }
  ...
  var CursorClass = /*#__PURE__*/ (function () {
    function CursorClass(rootElement) {
      ...
      if (el)
        this.setRange(
          el,
          (_el$textContent = el.textContent) === null || _el$textContent === void 0 ? void 0 : _el$textContent.length
        )
    }
    ...
    _createClass(CursorClass, [
      {
        ...
        value: function getRange() {
          try {
            ...
            // @ts-ignore
            return (_window$getSelection = window.getSelection()) === null || _window$getSelection === void 0
              ? void 0
              : _window$getSelection.getRangeAt(0)
          } catch (e) {
            // ..
          }
      ...
      },
      {
        ...
        value: function setRange(el, offset) {
          ...
          if (typeof offset === 'undefined') {
            ...
            offset =
              (_targetNode$textConte =
                (_targetNode$textConte2 = targetNode.textContent) === null || _targetNode$textConte2 === void 0
                  ? void 0
                  : _targetNode$textConte2.length) !== null && _targetNode$textConte !== void 0
                ? _targetNode$textConte
                : 0
          }
        ...
        value: function getCurrentNode() {
          ...
          while (currentNode && this.rootElement !== currentNode) {
            ...
            if (
              ...
              ((_currentNode$parentEl = currentNode.parentElement) === null || _currentNode$parentEl === void 0
                ? void 0
                : _currentNode$parentEl.parentElement) === this.rootElement
            ) {
              return currentNode
            }
    ...
    _createClass(EventEmitter, [
      ...
      },
      {
        ...
        value: function emit(eventName) {
          ...
          for (
            var _len = arguments.length, args = new Array(_len > 1 ? _len - 1 : 0), _key2 = 1;
            _key2 < _len;
            _key2++
          ) {
